...
| fx?      | String                        | The fx played by the skill. Used by 'Projectile', 'Tremor', 'JumpAttack', 'Attach', 'AttachAnim.                                           |
| anim?    | String                        | The animation used by the skill. Used by 'Projectile' and 'Anim'.                                                                          |
| type?    | Number                        | The type of skill to use. Used by 'Shower' (SkillType) and 'Aura' (AuraType). Can be set to 1 for 'Heal' to remove the leaves.             |
| speed?   | Number                        | The speed of the skill. Used by 'Projectile' and 'Rafale'.                                                                                 |
| power?   | Number                        | The power of the skill. Used by 'Rafale'.                                                                                                  |
| color?   | Number                        | Changes the color of the skill. Used by 'Aura', 'Cloud', and 'Focus'.                                                                      |
