...
| targets? | { id: Number, life?: Number } | The targets of the skill and the life gained/losed, if any. If life is set to null, the target dodge the skill with the 'special' animation. |
