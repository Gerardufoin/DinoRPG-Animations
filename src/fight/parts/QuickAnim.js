...
/**
 * A class allowing to instantiate an animation in the scene with a "3D" physic.
 * The animation should have a destroy callback to be automatically removed once done playing.
 */
export class QuickAnim extends Phys {
	/**
	 ...
	 * @param {number} z The z coordinate of the animation. 0 by default.
	 ...
	 */
	constructor(scene, animation, x = 0, y = 0, z = 0, side = 1, alpha = 1, scale = 1) {
