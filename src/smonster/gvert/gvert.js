...
export const gvert = {
	...
	parts: {
		...
		r_b_paw: parts.paw,
		r_f_paw: parts.paw,
		l_f_upper_leg: parts.front_upper_leg,
		l_f_lower_leg: parts.lower_leg,
		l_b_lower_leg: parts.lower_leg,
		r_b_lower_leg: parts.lower_leg,
		r_f_upper_leg: parts.front_upper_leg,
		r_f_lower_leg: parts.lower_leg,
		upper_body: parts.body,
		lower_body: parts.body,
		head: parts.head,
		r_b_upper_leg: parts.back_upper_leg,
		l_b_upper_leg: parts.back_upper_leg,
